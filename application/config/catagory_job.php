...
*/
$config['tables']['users']           = 'katagori';
$config['tables']['groups']          = 'lowongan';
$config['tables']['katagori']				 = 'industri';

$config['tables']['users_groups']    = 'lowongan_katagori';
$config['tables']['lowongan_katagori']	= 'lowongan_industri';
 ...
 */
$config['join']['users']  = 'katagori_id';
$config['join']['groups'] = 'lowongan_id';
...
$config['user_expire']                = 86040;               // How long to remember the user (seconds). Set to zero for no expiration
...
$config['lockout_time']               = 300;                 /* The number of seconds to lockout an account due to exceeded attempts You should not use a value below 60 (1 minute) */
