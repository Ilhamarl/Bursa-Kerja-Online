			...
			$i = 1; foreach ($catagories as $catagory){
				...
				<div class="box box-default">
					<div class="box-header with-border">
						<h2 class="box-title">
							<b><a href="<?php echo site_url('catagories/catagory/'.$catagory->id);?>"><?php echo $catagory->name;?></a></b>
						</h2>
				...
				-->
					<div class="box-footer">
						<a href="<?php echo site_url('catagories/catagory/'.$catagory->id);?>" class="btn btn-md btn-default"><i class="fa fa-eye" ></i> Detail</a>
